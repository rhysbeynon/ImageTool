...
$elapsedTime = Measure-Command{
 ...
 #logging logic
    $logFilePull = "\\lextandc01\backup\log\pull.log\log_img_" + $todaysDate + ".txt"
    $logFileSize = "\\lextandc01\backup\log\size.log\log_img_" + $todaysDate + ".txt"
    $logFilePush = "\\lextandc01\backup\log\push.log\log_img_" + $todaysDate + ".txt"
